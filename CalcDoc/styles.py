...
def set_style():
    ...
    # titel, subtitel
    styl.add(ParagraphStyle(name='Titel', leading=15, fontSize=12, fontName='Helvetica-Bold', alignment=TA_CENTER,
    ...
    styl.add(ParagraphStyle(name='SubTitel', leading=13, fontSize=11, fontName='Courier', alignment=TA_CENTER))
